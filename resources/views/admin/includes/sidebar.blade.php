  <div  class="w-64 absolute sm:relative bg-gray-800 shadow md:h-screen flex-col justify-between hidden sm:flex transition-all ease-in-out" id="Desktop_sidebar">
    <div class="px-8">
        <div class="h-16 w-full flex items-center">
          ...
          <ul class="mt-12">
              <li class="flex w-full justify-between  {{ (Route::currentRouteName() == "admin.dashboard") ? "text-gray-300" : "text-gray-400"}} cursor-pointer items-center mb-6">
                  <a href="{{ route('admin.dashboard') }}" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                  ...
                  <div class="py-1 px-3 bg-gray-600 rounded flex items-center justify-center text-xs">5</div>
              </li>
              <li class="flex w-full justify-between {{ (Route::currentRouteName() == "admin.products") ? "text-gray-300" : "text-gray-400"}} hover:text-gray-300 cursor-pointer items-center mb-6">
                  <a href="{{ route('admin.products') }}" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                      ...
                      <span class="text-md ml-2">Products</span>
                  </a>
                  <div class="py-1 px-3 bg-gray-600 rounded text-gray-300 flex items-center justify-center text-xs">8</div>
              </li>
              <li class="flex w-full justify-between {{ (Route::currentRouteName() == "admin.blogs") ? "text-gray-300" : "text-gray-400"}} hover:text-gray-300 cursor-pointer items-center mb-6">
                  <a href="{{ route('admin.blogs') }}" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                      ...
                      <span class="text-md ml-2">Blogs</span>
                  </a>
              </li>
              <li class="flex w-full justify-between {{ (Route::currentRouteName() == "admin.pages") ? "text-gray-300" : "text-gray-400"}} hover:text-gray-300 cursor-pointer items-center mb-6">
                  <a href="{{ route('admin.pages') }}" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white" >
                      ...
                      <span class="text-md ml-2">Pages</span>
                  </a>
              </li>
              <li class="flex w-full justify-between {{ (Route::currentRouteName() == "admin.settings") ? "text-gray-300" : "text-gray-400"}} hover:text-gray-300 cursor-pointer items-center">
                  <a href="{{ route('admin.settings') }}" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
          ...
          <div class="flex justify-center mt-48 mb-4 w-full">
              <div class="relative">
                  ...
                  <input class="bg-gray-700 focus:outline-none focus:ring-1 focus:ring-gray-100 rounded w-full text-md text-gray-300 placeholder-gray-400 bg-gray-100 pl-10 py-2" type="text" placeholder="Search" />
              </div>
          </div>
      </div>
        ...
        <ul class="mt-12">
            ...
            <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white" >
                    ...
                    <span class="text-md ml-2">Performance</span>
                </a>
            </li>
            <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
            ...
            <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                    ...
                    <span class="text-md ml-2">Invoices</span>
                </a>
            ...
            <li class="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                    ...
                    <span class="text-md ml-2">Inventory</span>
                </a>
            </li>
